...
### 공부한 책
- [A/B 테스트: 신뢰도 높은 온라인 통제 실험](http://www.yes24.com/Product/Goods/110044064) --- (공부 중)
- [데이터 과학을 위한 통계: 데이터 분석에서 머신러닝까지 파이썬과 R로 살펴보는 50가지 핵심 개념](http://www.yes24.com/Product/Goods/99942893) --- (공부 중)
- [데이터 익명화를 위한 파이프라인: 데이터를 안전하고 책임감 있게 사용하는 비식별화 방법](http://www.yes24.com/Product/Goods/108802594) --- (공부 중)
...
### 읽은 책
- [로지컬 라이팅: 맥킨지식 논리적 글쓰기의 기술](http://www.yes24.com/Product/Goods/76899650) --- (읽는 중)
