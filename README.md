...
4. 모태자펀드 규약(PDF파일 등) 내용 DB화 작업
5. AI 시스템 구축 업체 '애니파이브' 업무회의 참석 - 머신러닝 기반 추천시스템 논의
- 숭실대학교 창업동아리 '바로다스리기'팀 명상&헬스케어 어플리케이션 '무릉' 데이터분석/기획
- 공공데이터 청년인턴십 직무교육 이수 (발행주체 : 한국정보화진흥원 원장)
- 대학생 연합 빅데이터 동아리 BITAmin
- NHN의 어플리케이션 '핑크 다이어리'의 DAU 개선을 위한 뉴 비즈니스 모델 제시
- 삼성공인중개사 소속 공인중개사
- 부동산&경제 학회 NewLas: 공공데이터를 활용한 '상가 부동산 입지 선정' 프로젝트 다수
- SPSS 통계 분석: 교내 카페에 스마트오더(사이렌벨)를 도입한다면, 고객(학생)들은 이를 이용할 것인가
...
- 인프런) [파이썬입문과 크롤링기초 부트캠프](https://www.inflearn.com/course/Python-crawling-basic)
...
- ~~'Sung Kim' [모두를 위한 딥러닝 시즌1](https://www.youtube.com/playlist?list=PLlMkM4tgfjnLSOjrEJN31gZATbcj_MpUm)~~
