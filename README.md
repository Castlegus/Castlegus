### 부동산(프롭테크) 및 그로스해킹 그리고 성장에 관심이 많은 데이터 분석가

### 활동
- **2021.8 ~ 현재 원티드 데이터 분석가 프리온보딩 코스:**
  1) (원티드 제공) 국민 연금 DB 데이터를 활용하여 유니콘 기업 찾기 프로젝트
  2) (자비스앤빌런즈 제공) 데이터를 활용하여 결제 전환 관련 인사이트 찾기 프로젝트
     - 고객의 결제여부에 영향을 미치는 요인들은 무엇인가?
     - 고객의 수수료 결제금액의 합을 높히기 위해서는 어떻게 해야 할까?


- **2021.1 ~ 7 창업팀 '콘콘'팀 굿즈 커뮤니티 '오즈의제작소' 데이터분석:**
   1) 텍스트마이닝: 인스타그램 해시태그 크롤링을 통한 분석
   2) 웹 로그 분석: 구글 애널리틱스
   3) 웹 행동 분석: Hotjar


- **2020.8 ~ 7 대학생 연합 빅데이터 동아리 BITAmin:** 
